...
import com.marcoscouto.webservicesjpahibernate.entities.*;
import com.marcoscouto.webservicesjpahibernate.entities.enums.OrderStatus;
import com.marcoscouto.webservicesjpahibernate.repositories.*;
...
public class TestConfig implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        Product p1 = new Product(null, "The Lord of the Rings", "Lorem ipsum dolor sit emet, consectetur", 90.5, "");
        ...
        //Saving(Updating) the list of categories
        productRepository.saveAll(Arrays.asList(p1, p2, p3, p4, p5));
        ...
        orderRepository.save(o1); // Update the payment
